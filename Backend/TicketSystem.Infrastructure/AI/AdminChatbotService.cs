        ...
        public async Task<string> AskQuestionAsync(string question)
        {
            ...
            for (int i = 0; i <= maxRetries; i++)
            {
                try
                {
                    ...
                    promptBuilder.AppendLine("9. Khi người dùng yêu cầu tìm/chọn sự kiện theo địa điểm, chủ đề, số người hoặc ngân sách, PHẢI gọi hàm [search_events_by_criteria]. Không được tự suy đoán giá vé hoặc sự kiện.");

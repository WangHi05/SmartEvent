...
public static class DependencyInjection
{
    public static IServiceCollection AddApplicationServices(this IServiceCollection services)
    {
        ...
        // 2. (Đã xóa) AddHttpContextAccessor() — đã được đăng ký sẵn ở Program.cs (tầng API)

        // 3. Đăng ký các Service khác của tầng Application
        ...
        // 4. Đăng ký Refund Strategy Pattern

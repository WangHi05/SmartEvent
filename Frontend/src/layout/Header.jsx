    ...
    <header className="h-20 bg-white border-b border-gray-200 flex items-center justify-between px-6 transition-all duration-300">
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center gap-3 select-none">
          <div className="h-9 w-9 flex items-center justify-center rounded-xl bg-slate-50 border border-slate-200/60 p-1.5 shadow-sm shrink-0">
            <img 
              src="/logo.png" 
              alt="SmartEvent Logo" 
      ...
      <div className="flex items-center gap-6">
        ...
        {/* Nút thông báo */}
        <button className="text-gray-500 hover:text-indigo-600 relative transition-colors">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Avatar động */}
          <div className="w-10 h-10 rounded-full bg-indigo-600 flex items-center justify-center text-white font-bold text-lg shadow-md cursor-pointer hover:bg-indigo-700 transition-colors">
            {avatarLetter}
          </div>
        </div>

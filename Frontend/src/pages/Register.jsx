        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            <div className="hidden w-[42%] flex-col justify-between bg-gray-900 p-12 text-white lg:flex">
                ...
                <div className="max-w-md space-y-4">
                    ...
                    <p className="text-sm leading-6 text-gray-400">
                        Tạo tài khoản để đặt vé nhanh, theo dõi đơn hàng và nhận vé điện tử tức thì.
                    </p>
                </div>
            ...
            <div className="flex flex-1 items-center justify-center p-6 sm:p-10">
                <div className="w-full max-w-sm">
                    ...
                    <p className="mt-1 text-sm text-gray-500">Bắt đầu quản lý sự kiện của bạn ngay hôm nay</p>
                    ...
                    <div className="mt-8">
                        <div className="relative flex justify-center text-sm">
                            ...
                            <span className="relative bg-gray-50 px-3 text-gray-500 lg:bg-white">hoặc đăng ký với</span>
                        </div>

            ...
            <div className="w-full max-w-md bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/80 shadow-xl shadow-slate-100">
                ...
                <div className="mt-6">
                    <div className="relative flex justify-center text-sm">
                        ...
                        <span className="relative bg-white px-3 text-gray-500">hoặc đăng ký với</span>
                    </div>
                    <div className="mt-4 grid grid-cols-2 gap-3">
                        <button className="flex items-center justify-center gap-2 rounded-lg border border-gray-300 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50">
